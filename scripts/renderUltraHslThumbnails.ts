...
const episodeId = 'HSL_EPISODE_009_AI_DATACENTER_COOLING';

const imgFace = path.resolve('C:/Users/brend/AntigravityProfiles/work/.gemini/antigravity/brain/14e79f94-0e0b-404d-91a3-2af54a39b9ab/thumb_ai_cooling_face_1788139276831.jpg');
const imgSplit = path.resolve('C:/Users/brend/AntigravityProfiles/work/.gemini/antigravity/brain/14e79f94-0e0b-404d-91a3-2af54a39b9ab/thumb_ai_cooling_split_1788139328922.jpg');
const imgHero = path.resolve('C:/Users/brend/AntigravityProfiles/work/.gemini/antigravity/brain/14e79f94-0e0b-404d-91a3-2af54a39b9ab/thumb_ai_cooling_hero_1788139382244.jpg');
...
<svg xmlns="http://www.w3.org/2000/svg" width="1920" height="1080" viewBox="0 0 1920 1080">
  ...
  <g transform="translate(100 130)" filter="url(#heavyShadow)">
    <rect width="520" height="52" rx="6" fill="#0A0C14" stroke="#FFE500" stroke-width="2.5"/>
    <rect x="0" y="0" width="12" height="52" fill="#FFE500"/>
    <text x="32" y="34" class="badge" font-size="22" fill="#FFE500">THERMAL TRIP // 105°C</text>
  </g>

  <!-- 5. Giant Impact Headline -->
  <g filter="url(#heavyShadow)">
    <text x="95" y="340" class="heavy" font-size="145" fill="#FFFFFF" letter-spacing="-2px">NO LIQUID?</text>
    <text x="95" y="490" class="heavy" font-size="145" fill="#FFE500" letter-spacing="-2px">105°C MELTDOWN</text>
  </g>

  <!-- 6. Critical Telemetry Hud Pill -->
  <g transform="translate(100 580)" filter="url(#heavyShadow)">
    <rect width="680" height="74" rx="8" fill="#0A0D18" stroke="#00D8FF" stroke-width="2"/>
    <circle cx="36" cy="37" r="10" fill="#00D8FF" filter="url(#neonGlow)"/>
    <text x="64" y="45" class="mono" font-size="24" fill="#00D8FF">100,000 GPUS // 45,000 L/MIN DIELECTRIC</text>
  </g>

  <!-- 7. Optical Attention Pointer to Molten Silicon (Right Side) -->
...
<svg xmlns="http://www.w3.org/2000/svg" width="1920" height="1080" viewBox="0 0 1920 1080">
  ...
  <g transform="translate(100 120)" filter="url(#heavyShadow)">
    ...
    <text x="25" y="32" class="badge" font-size="20" fill="#00D8FF">FLOW: 45,000 L/MIN</text>
  </g>
  <g transform="translate(1460 120)" filter="url(#heavyShadow)">
    ...
    <text x="25" y="32" class="badge" font-size="20" fill="#FF2E00">PUMP TRIP // 45s</text>
  </g>

  <!-- 5. Giant Impact Headline Centered -->
  <g filter="url(#heavyShadow)">
    <text x="960" y="240" class="heavy" font-size="140" fill="#FFFFFF" text-anchor="middle" letter-spacing="-2px">100,000 GPUS</text>
    <text x="960" y="370" class="heavy" font-size="140" fill="#FFE500" text-anchor="middle" letter-spacing="-2px">VAPORIZE IN 45s</text>
  </g>
  ...
  <g transform="translate(100 920)" filter="url(#heavyShadow)">
    ...
    <text x="30" y="46" class="mono" font-size="24" fill="#00D8FF">NORMAL: 1.2 GW HEAT DISSIPATION // 45°C</text>
  </g>
  <g transform="translate(1020 920)" filter="url(#heavyShadow)">
    ...
    <text x="30" y="46" class="mono" font-size="24" fill="#FF2E00">COLLAPSE: 105.0°C SILICON JUNCTION TRIP</text>
  </g>

  <!-- 7. HSL Channel Bug -->
  <g transform="translate(960 1035)" filter="url(#heavyShadow)">
    <text x="0" y="0" class="mono" font-size="20" fill="#F4F4F0" opacity="0.8" text-anchor="middle">HIDDEN SYSTEMS LAB // EPISODE 009</text>
  </g>
</svg>`;
}
...
<svg xmlns="http://www.w3.org/2000/svg" width="1920" height="1080" viewBox="0 0 1920 1080">
  ...
  <g filter="url(#heavyShadow)">
    ...
    <text x="95" y="490" class="heavy" font-size="145" fill="#FFE500" letter-spacing="-2px">1.2 GIGAWATTS</text>
  </g>
  ...
  <g transform="translate(100 580)" filter="url(#heavyShadow)">
    ...
    <circle cx="36" cy="37" r="10" fill="#00D8FF" filter="url(#neonGlow)"/>
    <text x="64" y="45" class="mono" font-size="24" fill="#00D8FF">0.2mm COPPER COLD PLATE // JET IMPINGEMENT</text>
  </g>

  <!-- 7. Optical Precision Target Reticle on Copper Jet (Right Side) -->
  <g transform="translate(1100 520)" filter="url(#heavyShadow)">
    ...
    <text x="140" y="-30" class="mono" font-size="20" fill="#FFE500">200 WATTS / CM²</text>
  </g>
