...
- **Canal BRECHA** (documentário de defesa cotidiana e investigação forense brasileira):
  - **Ambientes reais cotidianos brasileiros:** cozinha com azulejos e fórmica, portaria de prédio com interfone, carro popular no trânsito, loja de bairro, ônibus urbano, calçada comercial. A ameaça entra na vida real, NUNCA em um "laboratório hacker" ou "bancada técnica investigativa com roteadores".
  - **Objetos tangíveis reconhecíveis:** celular comum, cartão de banco, comprovante Pix, boletos de contas mensais, chip SIM, chave, documento oficial.
  - **Estética documental crua e neutra:** iluminação funcional e neutra (luz fluorescente branca de cozinha/portaria, lâmpada de teto comum, dia nublado difuso). PROIBIDO golden hour, "luz suave de fim de tarde", "madeira maciça nobre" ou "vapor subindo de xícara de café". Paleta majoritariamente neutra baseada em carvão (`#0D0D0F`), osso (`#E8E2D7`), cinzas e fórmica. O coral (`#FF5A47`) é reservado estritamente para a fenda e o elemento explorado (5% a 12% do frame).
  - **Política de Personagem (characterPolicy):** Presença humana estritamente `periférica` ou `ausente`. O objeto ou documento é o protagonista absoluto. Mãos em plano detalhe estritamente funcional (atender, digitar, segurar papel), sem poses artificiais de banco de imagens. PROIBIDO qualquer close frontal dramático em rostos ou expressões forçadas de susto/terror ("expressão de thumbnail apelativa").
  ...
  - **Evidência Real obrigatória:** Cenas de evidência devem retratar documentos autênticos (relatórios do Banco Central MED, Febraban, boletins da SSP, extratos bancários com blur de privacidade), nunca imagens de IA fingindo ser prova ou bancadas com laptops e fones.
  - **Retorno ao Objeto no Fechamento:** O fechamento (Ato 4) encerra com retorno visual obrigatório ao mesmo objeto do cold open (o mesmo smartphone sobre a mesma bancada de fórmica/granito da Cena 1, com a chamada rejeitada e o app oficial seguro). Três passos de defesa práticos em menos de 10 minutos (zero chaves físicas YubiKey ou hardware gringo).
  ...
  - **Proibição absoluta de clichês:** zero hackers de capuz, zero chuva de código verde estilo Matrix, zero neon azul/vermelho, zero bancadas investigativas cenográficas, zero pulsos concêntricos.
